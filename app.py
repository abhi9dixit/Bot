...
for files in os.listdir('E:/fb-messenger-bot/zchatbot/chatterbot-corpus-master\chatterbot_corpus\data\english/'):
    data = open('E:/fb-messenger-bot/zchatbot/chatterbot-corpus-master\chatterbot_corpus\data\english/' + files, 'r').readlines()
    bot.train(data)
